...
import 'package:ewa_kit/utils/network/ewa_cache_manager.dart';
...
class EwaHttpClient {
  ...
  factory EwaHttpClient() => _override ?? _instance;
  ...
  Duration _maxRetryDuration = const Duration(minutes: 2);
  ...
  Future<void> init({
    ...
    Duration maxRetryDuration = const Duration(minutes: 2),
  }) async {
  ...
  Dio get dio {
    assert(_initialized, 'EwaHttpClient.init() must be called before use');
    return _dio;
  }
